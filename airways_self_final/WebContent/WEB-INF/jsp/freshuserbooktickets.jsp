...
    <li><a href="login" style="color:orange;">Log in</a></li>
    <li><a href="#">Book Tickets</a></li>
    <li><a href="#">Confirm Tickets</a></li>
</ul>
...
<form:form commandName="passenger" action="freshaddpassenger" >
...
AGE : <form:input path="passengerage15" type="number" min="0" max="3"/>
...
<hr><hr>
<input type="submit" id="fresh" value="ADD" class="btn btn-grey flat btn-lg" style="width: 200px;margin-left: 431px;"/>
</form:form>
<br/><br/>
      </div>
