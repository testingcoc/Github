...
input:focus { box-shadow: inset 0 -5px 45px rgba(100,100,100,0.4), 0 1px 1px rgba(255,255,255,0.2); }
  ...
  <div class="login">
	<h1> Admin Login</h1>
    <form:form commandName="home" action="Alogin" >
    	<input name="adminname" type="text"  placeholder="Username" required="required" />
        <input name="adminpass"  type="password" placeholder="Password" required="required" />
        <button type="submit" class="btn btn-primary btn-block btn-large">Let me in.</button>
    </form:form><br/><br/>
    <a href="home" style="color: wheat;">Not Admin !!  GO BACK TO HOME PAGE</a>
</div>
